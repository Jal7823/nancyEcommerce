...
class UpdateProfileUser(forms.ModelForm):
    class Meta:
        model = Usuario
        fields = ('username','nombre', 'apellido', 'email','dni','direc','loc','pcia','tlf')
        labels = {
            'nombre':'Nombre',
            'apellido':'Apellido',
            'direc':'Direccion',
...
class crearUsuariosPanel(forms.ModelForm):
    ...
    class Meta:
        model = Usuario
        fields = ('username','email','password1','password2','nombre','usuario_administrador',)
        labels = {
            'usuario_administrador':'Acceso al panel administrativo'
